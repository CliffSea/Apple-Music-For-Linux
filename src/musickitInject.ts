// Credits:
// https://github.com/web-scrobbler/web-scrobbler/blob/9880c498a90025e3b0cf4748943246e0ccf52c94/src/connectors/musickit-dom-inject.ts
...
(window as unknown as { cleanup: () => Promise<void> }).cleanup = (() => {
	...
	async function addEventListeners() {
        ...
        instance.addEventListener(Events.playbackTimeDidChange, sendEvent);
		sendEvent();
	}
	...
	function getArtwork(url: string) {
		return url.replace('{w}x{h}bb', '1024x1024bb');
	}
	...
	return async () => {
        ...
        instance.removeEventListener(Events.playbackTimeDidChange, sendEvent);
	};
})();
